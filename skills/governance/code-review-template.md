...
**Location**: `docs/internal/code_review/YYYY-MM-DD-<brief-slug>.md`
...
The **Standard** column (§N) references sections from [standards.md](../../../docs/internal/architecture/standards.md):
- §1 - Code Quality
- §2 - Testing
- §3 - Workflow
- §4 - Security
