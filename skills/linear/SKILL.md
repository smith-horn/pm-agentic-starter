...
**Use the official Linear MCP server.** Run this command in your terminal:

```bash
claude mcp add --transport http linear-server https://mcp.linear.app/mcp
```

Then open a Claude Code session and run `/mcp` to authenticate with your Linear account.
